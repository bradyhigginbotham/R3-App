...
// in simulator we redefine to format for AITPR3 Developer console
...
{\
	NSString * exceptionName = [@"org.aitpr3." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.aitpr3";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAITPR3NativeItemNone = -1, 
	UIAITPR3NativeItemSpinner = -2,
	UIAITPR3NativeItemProgressBar = -3,
	
	UIAITPR3NativeItemSlider = -4,
	UIAITPR3NativeItemSwitch = -5,
	UIAITPR3NativeItemMultiButton = -6,
	UIAITPR3NativeItemSegmented = -7,
	
	UIAITPR3NativeItemTextView = -8,
	UIAITPR3NativeItemTextField = -9,
	UIAITPR3NativeItemSearchBar = -10,
	
	UIAITPR3NativeItemPicker = -11,
	UIAITPR3NativeItemDatePicker = -12,
	
	UIAITPR3NativeItemInfoLight = -13,
	UIAITPR3NativeItemInfoDark = -14,
	
	UIAITPR3NativeItemDisclosure = -15,
	
	UIAITPR3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AITPR3 instances of
