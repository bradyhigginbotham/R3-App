...
// in simulator we redefine to format for r3test Developer console
...
{\
	NSString * exceptionName = [@"org.r3test." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.r3test";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIr3testNativeItemNone = -1, 
	UIr3testNativeItemSpinner = -2,
	UIr3testNativeItemProgressBar = -3,
	
	UIr3testNativeItemSlider = -4,
	UIr3testNativeItemSwitch = -5,
	UIr3testNativeItemMultiButton = -6,
	UIr3testNativeItemSegmented = -7,
	
	UIr3testNativeItemTextView = -8,
	UIr3testNativeItemTextField = -9,
	UIr3testNativeItemSearchBar = -10,
	
	UIr3testNativeItemPicker = -11,
	UIr3testNativeItemDatePicker = -12,
	
	UIr3testNativeItemInfoLight = -13,
	UIr3testNativeItemInfoDark = -14,
	
	UIr3testNativeItemDisclosure = -15,
	
	UIr3testNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all r3test instances of
