...
/**
 The base class for all AITPR3 modules
 */
...
/**
 AITPR3 Platform calls this method on startup.
 */
-(void)startup;

/**
 AITPR3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AITPR3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
