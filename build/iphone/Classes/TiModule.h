...
/**
 The base class for all r3test modules
 */
...
/**
 r3test Platform calls this method on startup.
 */
-(void)startup;

/**
 r3test Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 r3test Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 r3test Platform calls this method on resume.
 @param sender The sender of the event.
 */
