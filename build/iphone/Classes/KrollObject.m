 ...
 * Copyright (c) 2009-2011 by AITPR3, Inc. All Rights Reserved.
...
//@interface AITPR3Object : NSObject
//@end

@interface AITPR3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AITPR3Object class]])
		{
			for (NSString *key in [[(AITPR3Object*)o modules] allKeys])
			{
