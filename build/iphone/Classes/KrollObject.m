 ...
 * Copyright (c) 2009-2011 by r3test, Inc. All Rights Reserved.
...
//@interface r3testObject : NSObject
//@end

@interface r3testObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[r3testObject class]])
		{
			for (NSString *key in [[(r3testObject*)o modules] allKeys])
			{
